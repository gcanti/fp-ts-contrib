...
describe('iterable', () => {
    ...
    it('toReadonlyArray', () => {
      fc.assert(
        fc.property(fc.array(fc.integer()), (ix) => {
          expect(iterable.toReadonlyArray(iterable.fromIterable(ix))).toStrictEqual(ix)
        })
      )
    })
  })
  ...
  describe('typeclasses', () => {
    ...
    describe('Applicative', () => {
      it('laws', () => {
        laws.applicative(iterable.Applicative)((a) => a.map(iterable.of), iterable.getEq)
      })
    })
    ...
    describe('FunctorWithIndex', () => {
      ...
      it('mapWithIndex', () => {
        fc.assert(
          fc.property(fc.array(fc.integer()), (ix) => {
            const result = pipe(
              iterable.FunctorWithIndex.mapWithIndex(iterable.fromIterable(ix), (i, a) => tuple(a, i)),
